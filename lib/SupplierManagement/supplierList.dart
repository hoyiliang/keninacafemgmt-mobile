...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const SupplierListPage(user: null,),
    );
  }
}

class SupplierListPage extends StatefulWidget {
  const SupplierListPage({super.key, this.user});
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text('Person Responsible: GOH CHEE LAM'),
                        Text('Address: 12, PERSIARAN ANGGERIK 4'),
                      ],
                    ),
                  ),
                ],
