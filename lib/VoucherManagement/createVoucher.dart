...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const CreateVoucherPage(user: null, streamControllers: null),
    );
  }
}

class CreateVoucherPage extends StatefulWidget {
  const CreateVoucherPage({super.key, this.user, this.streamControllers});
...
class _CreateVoucherPageState extends State<CreateVoucherPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppsBarState().buildAppBarDetails(context, 'Create Voucher', currentUser!, widget.streamControllers),
      body: SafeArea(
  ...
  Future<(bool, String)> createVoucher(String voucherCode, String redeemPoint, String voucherTypeName, String costOff, String minSpending, String freeMenuItemName, String applicableMenuItemName, User currentUser) async {
    try {
      ...
      return (false, (ErrorCodes.CREATE_NEW_VOUCHER_FAIL_API_CONNECTION));
    }
  }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to create the new voucher (${voucherCodeController.text})?'),
          actions: [
            ElevatedButton(
              onPressed: () async {
